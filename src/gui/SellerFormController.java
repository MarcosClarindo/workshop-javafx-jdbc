...
public class SellerFormController implements Initializable {
	...
	private Seller getFormData() {
		...
		if (dpBirthDate.getValue() == null) {
			exception.addError("birthDate", "Fild can´t empty");
		}else {
		...
		obj.setBaseSalary(Utils.tryParseToDouble(txtBaseSalary.getText())); // passando string para Double
	...
	public void updateFormData() {
		...
		// pegando o primeiro elemento do comboBox se estiver null
