...
public class SellerListController implements Initializable, DataChangeListener {
	...
	private SellerService service; // dependência
	...
	@FXML
	private TableColumn<Seller, Integer> tableColumnId; // nome da variável
	...
	private void createDialogForm(Seller obj, String absoluteName, Stage parentStage) {
		...
		try {
			...
			e.printStackTrace(); // para exibir as mensagens de erro no console
	...
	// criando um botão em cada linha da tabela
	...
	private void removeEntity(Seller obj) {
		...
		if(result.get()== ButtonType.OK) {
			...
			// lançando um alert para esse tratamento
